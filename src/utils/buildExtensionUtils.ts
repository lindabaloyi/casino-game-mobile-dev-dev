 ...
 */
export function insertCardIntoBuildDescending(sortedCards: Card[], newCard: Card): Card[] {
 ...
 */
export function validateBuildExtensionOrder(buildCards: Card[], extensionCard: Card): boolean {
